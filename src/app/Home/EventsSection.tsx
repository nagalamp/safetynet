            ...
            >
              ...
              <div className="relative w-full h-[472px]">
                ...
                <div className="absolute inset-0 flex flex-col justify-between p-6">
                  <div>
                    <p
                      className={`text-[22px] font-outfit font-medium mb-3 transition-colors duration-500 ${
                        hoveredCard === study.id ? 'text-white' : 'text-[#150e24]'
                      }`}
                    ...
                    <h3
                      className={`text-[32px] font-outfit font-semibold mb-6 transition-colors duration-500 ${
                        hoveredCard === study.id ? 'text-white' : 'text-[#150e24]'
                      }`}
                    ...
                    <p
                      className={`text-[18px] font-open-sans leading-relaxed transition-colors duration-500 ${
                        hoveredCard === study.id ? 'text-white' : 'text-[#150e24]'
                      }`}
                  ...
                  {/* Button */}
                  <motion.button
                    className={`w-full py-3 px-8 rounded text-[20px] font-outfit font-semibold transition-colors duration-300 ${
                      hoveredCard === study.id ? 'bg-white text-[#f05623]' : 'bg-[#f05623] text-white'
                    }`}
