...
export default function ServiceDetailPage() {
  ...
  const serviceCards = [
    ...
    { icon: "/images/Close.svg", hoverIcon: "/images/Close-hover.svg", title: "Planningn", points: ["Weekly task scheduling", "Progress tracking and reporting", "Vendor and material coordination"], slug: "stand-auditing-services" },
    ...
    { icon: "/images/Services-Icons/Health-Safety/Setup_01.svg", hoverIcon: "/images/Services-Icons/Health-Safety/Setup_02.svg", title: "Risk Assesssssment", points: ["Identify potential hazards", "Evaluate risk levels", "Provide mitigation strategies"], slug: "health-safety-services" },
    { icon: "/images/All_Services_icon_SVG/Health-Safety/Setup_02.svg", hoverIcon: "/images/All_Services_icon_SVG/Health-Safety/Setup_02-hover.svg", title: "Safety Training", points: ["Conduct safety workshops", "Provide emergency response training", "Certify employees for compliance"], slug: "health-safety-services" },
    { icon: "/images/All_Services_icon_SVG/Health-Safety/Setup_02.svg", hoverIcon: "/images/All_Services_icon_SVG/Health-Safety/Setup_02-hover.svg", title: "Compliance Audits", points: ["Check adherence to safety regulations", "Review documentation", "Report compliance gaps"], slug: "health-safety-services" },
    { icon: "/images/All_Services_icon_SVG/Health-Safety/Setup_02.svg", hoverIcon: "/images/All_Services_icon_SVG/Health-Safety/Setup_02-hover.svg", title: "Incident Reporting", points: ["Record workplace incidents", "Investigate causes", "Recommend preventive measures"], slug: "health-safety-services" },
  
    // Electrical Safety Services
    { icon: "/images/electrical.png", hoverIcon: "/images/electrical-hover.png", title: "Electrical Inspection", points: ["Routine inspection of circuits", "Detect electrical hazards", "Ensure equipment safety"], slug: "electrical-safety-services" },
    { icon: "/images/electrical.png", hoverIcon: "/images/electrical-hover.png", title: "Wiring Safety", points: ["Check building wiring compliance", "Identify overloaded circuits", "Recommend upgrades"], slug: "electrical-safety-services" },
    { icon: "/images/electrical.png", hoverIcon: "/images/electrical-hover.png", title: "Equipment Testing", points: ["Test electrical equipment performance", "Detect faulty components", "Certify safe operation"], slug: "electrical-safety-services" },
    { icon: "/images/electrical.png", hoverIcon: "/images/electrical-hover.png", title: "Emergency Response", points: ["Prepare for electrical accidents", "Conduct drills", "Train staff in emergency protocols"], slug: "electrical-safety-services" },
  
    // Fire Safety Services
    { icon: "/images/fire.png", hoverIcon: "/images/fire-hover.png", title: "Fire Risk Assessment", points: ["Identify fire hazards", "Evaluate risk levels", "Recommend preventive measures"], slug: "fire-safety-services" },
    { icon: "/images/fire.png", hoverIcon: "/images/fire-hover.png", title: "Fire Safety Training", points: ["Conduct fire drills", "Train staff in fire response", "Certify emergency preparedness"], slug: "fire-safety-services" },
    { icon: "/images/fire.png", hoverIcon: "/images/fire-hover.png", title: "Fire Equipment Inspection", points: ["Check fire extinguishers and alarms", "Test sprinkler systems", "Ensure equipment compliance"], slug: "fire-safety-services" },
    { icon: "/images/fire.png", hoverIcon: "/images/fire-hover.png", title: "Emergency Evacuation Planning", points: ["Design evacuation routes", "Conduct mock drills", "Provide evacuation guidelines"], slug: "fire-safety-services" },
    ...
    { icon: "/images/event.png", hoverIcon: "/images/event-hover.png", title: "Event Risk Assessment", points: ["Identify risks at large events", "Plan mitigation strategies", "Ensure participant safety"], slug: "event-strategic-safety-services" },
    { icon: "/images/event.png", hoverIcon: "/images/event-hover.png", title: "Crowd Management", points: ["Monitor crowd flow", "Prevent overcrowding", "Train staff in crowd control"], slug: "event-strategic-safety-services" },
    { icon: "/images/event.png", hoverIcon: "/images/event-hover.png", title: "Emergency Planning", points: ["Develop event emergency plans", "Coordinate with authorities", "Conduct mock drills"], slug: "event-strategic-safety-services" },
    { icon: "/images/event.png", hoverIcon: "/images/event-hover.png", title: "Security Coordination", points: ["Align with security teams", "Manage access points", "Ensure overall event safety"], slug: "event-strategic-safety-services" },
    ...
    // Rigging Services
    { icon: "/images/rigging.png", hoverIcon: "/images/rigging-hover.png", title: "Rigging Planning", points: ["Design rigging setup plans", "Assess load requirements", "Ensure safety standards compliance"], slug: "rigging-services" },
    { icon: "/images/rigging.png", hoverIcon: "/images/rigging-hover.png", title: "Equipment Setup", points: ["Install rigging equipment safely", "Coordinate lifting operations", "Monitor equipment performance"], slug: "rigging-services" },
    { icon: "/images/rigging.png", hoverIcon: "/images/rigging-hover.png", title: "Safety Inspection", points: ["Check rigging connections", "Verify load-bearing components", "Conduct regular safety audits"], slug: "rigging-services" },
    { icon: "/images/rigging.png", hoverIcon: "/images/rigging-hover.png", title: "Operational Support", points: ["Assist during live events", "Monitor rigging performance", "Respond to operational issues"], slug: "rigging-services" },
  
    // Engineering Services
    { icon: "/images/engineering.png", hoverIcon: "/images/engineering-hover.png", title: "Structural Design", points: ["Design building and structural layouts", "Ensure compliance with safety codes", "Provide optimization recommendations"], slug: "engineering-services" },
    { icon: "/images/engineering.png", hoverIcon: "/images/engineering-hover.png", title: "Project Management", points: ["Oversee engineering projects", "Coordinate resources and schedules", "Monitor progress and quality"], slug: "engineering-services" },
    { icon: "/images/engineering.png", hoverIcon: "/images/engineering-hover.png", title: "Technical Consultation", points: ["Provide engineering expertise", "Recommend innovative solutions", "Ensure regulatory compliance"], slug: "engineering-services" },
    { icon: "/images/engineering.png", hoverIcon: "/images/engineering-hover.png", title: "Maintenance & Inspection", points: ["Conduct routine equipment inspections", "Ensure operational efficiency", "Provide maintenance schedules"], slug: "engineering-services" },
  ];
