...
const HeaderNoMenu = () => {   // ✅ Renamed here
  ...
  const renderCountryDropdown = () => (
    <div
      className={`
        absolute right-0 mt-3 w-36 z-50 bg-[#0f111a] border border-[#3a3a4a]
        rounded shadow-xl overflow-hidden origin-top-right transition-all duration-200 ease-out
  ...
  const renderLogoDropdown = () => (
    <div
      className={`
        absolute left-0 mt-3 w-40 z-50 bg-[#0f111a]
  ...
  return (
    <motion.header
      className={`
        ...
        ${isScrolled ? 'bg-[#150e24]/95 backdrop-blur-md border-b border-[#312e5c]' : 'bg-transparent'}
      `}
      initial={{ y: -100 }}
      animate={{ y: 0 }}
    ...
    >
      <div className="max-w-[1202px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Mobile menu (empty except country selector) */}
        <div
          className={`
          ...
          `}
        >
          <div className="p-6 mt-2 rounded-2xl bg-[#150e24]/80 backdrop-blur-md">
...
export default HeaderNoMenu;   // ✅ Updated export
